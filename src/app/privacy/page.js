      ...
      <section className="text-white pt-[14rem] py-4 min-h-screen">
        <div className="max-w-[85%] bg-transparent mx-auto">
          ...
          <article className="mb-10">
            <h2 className="text-2xl font-semibold mb-4 text-[#FFAD00]">Your Privacy Matters</h2>
            ...
            <p className="mt-4 text-gray-300 leading-relaxed tracking-wider">
              Lorem Ipsum is simply dummy text of the printing and typesetting industry.
          ...
          <article className="mb-10">
            <h2 className="text-2xl font-semibold mb-4 text-[#FFAD00]">How We Use Your Information</h2>
            <ul className="tracking-wider list-disc list-outside px-5">
              ...
              <li className="mt-4 text-gray-300 leading-relaxed">
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of
                type and scrambled it to make a type specimen book. It has survived not only five centuries, but
                also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in
