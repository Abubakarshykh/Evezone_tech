...
export default function Footer() {
  return (
    <footer
      className="relative w-full pt-[5rem] pb-10 bg-[#FFAD00] border-t-4 border-[#F9E68C] p-6 text-white text-lg font-bold text-center"
    ...
    >
      ...
      <Image 
        ...
        className="absolute right-5 bottom-10 opacity-100 mix-blend-normal pointer-events-none"
      />
